...
public class GameStats
{
    ...
    //Player Favour
    public int faction1Favour = 50; //Alpha Faction     - pacifist
    public int faction2Favour = 50; //Beta Faction      - pacifist
    public int faction3Favour = 50; //Gamma Faction     - swarmer
    public int faction4Favour = 50; //Omega Faction     - detonator
    public int faction5Favour = 50; //Epsilon Faction   - collector
